...
For mo# Email sender: use verified Brevo sender for the environment
# Both stage and master: indiancricket.ghent@gmail.com (verified sender)
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "IndCric <indiancricket.ghent@gmail.com>")rmation on this file, see
...
if DEBUG:
    DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "akhilbelgium08@gmail.com")
else:
